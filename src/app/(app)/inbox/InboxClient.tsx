                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      {doc.file_path && (
                        <a
                          ...
                          className="flex items-center gap-1.5 bg-emerald-50 dark:bg-emerald-950/30 hover:bg-emerald-100 dark:hover:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 text-xs font-medium px-3 py-2 rounded-xl transition-colors min-h-[36px]"
                          title="Voir le document original"
                          aria-label="Voir le document original"
                        >
                          <FileText size={14} />
