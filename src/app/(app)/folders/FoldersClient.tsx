...
import { Folder, FolderOpen, FileText, ChevronRight, AlertCircle, Clock } from 'lucide-react'
...
export default function FoldersClient({ folders, documents }: { folders: FolderData[]; documents: DocumentSummary[] }) {
