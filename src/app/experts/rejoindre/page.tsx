      ...
      <div className="flex-1 max-w-2xl mx-auto w-full px-4 sm:px-6 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-neutral-900 mb-2">
            Rejoignez l&apos;annuaire Tloush
          </h1>
          <p className="text-neutral-500 text-sm">
            Connectez-vous avec des milliers de salariés francophones en Israël
            qui cherchent exactement votre expertise.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Clients francophones qualifiés",
            },
            {
              Icon: TrendingUp,
              title: "Leads qualifiés",
              desc: "Via l'outil d'analyse",
            },
            {
              Icon: Shield,
              title: "Profil vérifié",
              desc: "Badge de confiance",
            },
          ].map(({ Icon, title, desc }) => (
            <div
              key={title}
        ...
        {status === "success" ? (
          <div className="bg-white rounded-2xl border border-neutral-100 p-8 text-center">
            ...
            <h2 className="font-bold text-xl text-neutral-800 mb-2">
              Demande reçue !
            </h2>
            <p className="text-neutral-500 text-sm">
              Nous examinerons votre profil et vous contacterons sous 48h pour
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-sm border border-neutral-200 rounded-xl focus:outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100"
                  />
                </div>
                <div>
                  <label className="block text-xs font-medium text-neutral-600 mb-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-3 py-2 text-sm border border-neutral-200 rounded-xl focus:outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100 bg-white"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 text-sm border border-neutral-200 rounded-xl focus:outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100 resize-none"
                />
              </div>
