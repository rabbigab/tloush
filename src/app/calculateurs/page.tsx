...
import { Calculator, Banknote, CalendarDays, TrendingDown } from "lucide-react";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "Calculateurs salaire Israël — Tloush",
  description: "Calculez votre salaire net, vos indemniés de licenciement et vos congés payés en Israël. Outils gratuits pour salariés francophones.",
};
...
const CALCULATORS = [
  {
    ...
    description: "Estimez votre salaire net à partir du brut. Prend en compte Bituah Leumi, impôt sur le revenu et points de crédit.",
  ...
  },
  {
    ...
    description: "Calculez vos indemniés de licenciement selon votre ancienneté et votre salaire de référence.",
    badge: null,
    color: "orange",
  },
  {
    ...
    description: "Calculez vos jours de congés accumulés et leur valeur monétaire en cas de départ.",
    badge: null,
    color: "green",
  },
];
    ...
    <main className="min-h-screen flex flex-col bg-neutral-50">
      ...
      <div className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 py-10">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-neutral-900 mb-3">Calculateurs</h1>
          <p className="text-neutral-500 max-w-xl mx-auto text-sm">
            Des outils de calcul précis, basés sur la législation israélienne en vigueur en 2024.
            Gratuits et sans inscription.
          </p>
        </div>

        <div className="grid gap-5 sm:grid-cols-3">
          {CALCULATORS.map(({ href, icon: Icon, emoji, title, description, badge }) => (
            <Link
              key={href}
              href={href}
        ...
        <div className="mt-10 bg-neutral-100 rounded-2xl p-5 text-center">
          <p className="text-xs text-neutral-500">
            ⚠️ Ces calculateurs sont fournis à titre indicatif. Les montants exacts peuvent varier selon votre convention collective, contrat individuel et situation personnelle.
