    ...
    <header className="sticky top-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-neutral-100 dark:border-slate-700 shadow-sm">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2.5 group shrink-0">
          <Image src="/icon.png" alt="Tloush" width={40} height={40} className="w-9 h-9 sm:hidden rounded-lg" />
          <span className="font-bold text-lg text-neutral-900 dark:text-white sm:hidden">Tloush</span>
          <Image src="/logo.png" alt="Tloush" width={1024} height={1024} className="hidden sm:block h-14 lg:h-16 w-auto group-hover:scale-105 transition-transform" priority />
        </Link>
